...
const hat_collar = new THREE.Mesh(new THREE.CylinderGeometry(40, 40, 5, 30), hatMaterial)
...
const right_eye = new THREE.Mesh(new THREE.SphereGeometry(5, 25, 40), eyeMaterial)
right_eye.position.set(15, 18, 30)

const left_eye = new THREE.Mesh(new THREE.SphereGeometry(5, 10, 40), eyeMaterial)
...
const body = new THREE.Mesh(new THREE.SphereGeometry(50, 50, 50), headMaterial)
